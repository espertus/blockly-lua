 ...
 * workspace.
 * Throws an error if the block type is not specified or if the XML
 * specification cannot be converted into a legal block, such as if it
 * includes an input not present for this type of block.
