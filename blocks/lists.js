...
Blockly.Blocks['lists_add'] = {
  // Add element to start or end of list.
  init: function() {
    var LOCATION =
        [['at start', 'START'], ['at end', 'END']];
    this.setColour(260);
    this.appendDummyInput()
        .appendTitle('to list')
        .appendTitle(new Blockly.FieldVariable('mylist'), 'VAR');
    this.appendValueInput('ELEMENT')
        .appendTitle('add element');
    this.appendDummyInput()
        .appendTitle(new Blockly.FieldDropdown(LOCATION), 'LOCATION');
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
